...
\begin{document}
\includepdf[pages={3}]{NSI-2021-metropole-1-sujet-officiel_corr.pdf}
\includepdf[pages={4}]{NSI-2021-metropole-2-sujet-officiel_corr.pdf}
\includepdf[pages={2}]{NSI-2021-metro-cand-libre-2-sujet-officiel_corr.pdf}
\includepdf[pages={3-4}]{NSI-2021-metro-cand-libre-1-sujet-officiel_corr.pdf}
