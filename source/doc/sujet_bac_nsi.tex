...
\begin{document}
\includepdf[pages={4-5}]{NSI-2021-metropole-1-sujet-officiel.pdf}
\includepdf[pages={8-9}]{NSI-2021-metropole-2-sujet-officiel.pdf}
\includepdf[pages={4-5,13}]{NSI-2021-metro-cand-libre-2-sujet-officiel.pdf}
\includepdf[pages={6-7}]{NSI-2021-metro-cand-libre-1-sujet-officiel.pdf}
